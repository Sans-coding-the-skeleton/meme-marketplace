            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                ...
                <div className="relative w-full md:w-1/3">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600"
                        value={searchTerm}
                ...
                <div className="flex gap-4 w-full md:w-auto">
                    {/* Category SELECT */}
                    <select
                        className="w-1/2 md:w-auto p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600"
